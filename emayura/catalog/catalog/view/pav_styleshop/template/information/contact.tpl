...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <!--Start: Panha Morn, 04202015: Hidding map from contact -->  
      <!--h3><?php echo $text_location; ?></h3-->

      <div class="contact-location hidden-xs">
                  
                  <!--div id="contact-map"></div-->
                  <!--End: Panha Morn, 04022015 -->
      </div>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            ...
            mapDiv.height(400).gmap3({
                ...
                marker:{
                    values:[
                        {latLng:[lat, lon], data:"<?php echo isset($themeConfig['location_address'])?$themeConfig['location_address']:'#AZ35, St. 371, Sangkat Teuk Thla, Khan Sen Sok, Phnom Penh, Cambodia'; ?>"},
                    ],
                    options:{
                        draggable: false
                    },
